...
bool areBracketsBalanced(string expr) {
    ...
    // 4. Setelah loop selesai, jika stack kosong, return true. Jika tidak, return false. stack harus kosong untuk seimbang
    bool isBalanced = (stackTop == nullptr);
    // Bersihkan sisa node di stack
    while (stackTop != nullptr) {
        pop(stackTop);                      
    }
    return isBalanced; // Placehorder
}
